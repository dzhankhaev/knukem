...
int             load_buttons(t_all *all, t_button *buttons)
{
    ...
    buttons[3].dstrect = (SDL_Rect){(W / 4 - 4) - 75, 300, 50, 50};
    ...
    buttons[5].dstrect = (SDL_Rect){(W / 4 - 4) - 75, 500, 50, 50};
